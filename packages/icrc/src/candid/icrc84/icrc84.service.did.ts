...
export type CancelOrderError = { 'UnknownOrder': null } |
...
export type LogEvent = { 'withdraw': { 'to': Account, 'amount': bigint } } |
...
{ 'CallIcrc1LedgerError': null } |
{ 'InsufficientFunds': { 'balance': bigint } };
export type UpperResult = { 'Ok': OrderId } |
{ 'Err': ReplaceOrderError };
export type UpperResult_1 = { 'Ok': bigint } |
{ 'Err': RegisterAssetError };
export type UpperResult_2 = { 'Ok': OrderId } |
{ 'Err': PlaceOrderError };
export type UpperResult_3 = { 'Ok': Array<OrderId> } |
{ 'Err': ManageOrdersError };
export type UpperResult_4 = { 'Ok': null } |
...
export interface _SERVICE {
    ...
    'placeBids': ActorMethod<
        ...
        Array<UpperResult_2>
    >,
    'principalToSubaccount': ActorMethod<
        [Principal],
        [] | [Uint8Array | number[]]
    >,
    ...
    'queryUserCreditsInTokenHandler': ActorMethod<
        [Principal, Principal],
        bigint
    >,
